...
\begin{czech}
\quote{\cond``Pojmenované entity jsou jednotlivá slova nebo slovní spojení, která v textu vystupují jako
pojmenování osob, míst, firem apod. Cílem anotace je označení všech pojmenovaných entit v 
předloženém lineárním textu. Současná anotace bude zaměřena na identifikaci především těch 
pojmenovaných entit, které jsou zapsány s velkým počátečním písmenem.''}
\end{czech}

It is however very hard to define named entities. Other authors do not fare much better: ?? definice sem!

We can say that to be considered  named entity an expresion must share at least some {\xxx or all ??} features of idioms: it cannot be an exploitation \citep[see]{hanks:norms}, i.e. it must fulfill some criteria of stability. {\xxx Any more??}
