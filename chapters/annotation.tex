...
annotator 1  & sid  & .    & .    & .    & .    & .    & .    & .    & .    \\
annotator 2  & vim  & .    & .    & .    & .    & .    & .    & .    & .    \\
$\kappa_w^U$  & 6714 & 7474 & 7289 & 7312 & 7029 & 6622 & 6162 & 6703 & 6804 \\
\hline
\end{tabular}
...
\begin{figure}[htbp]
   ...
   \caption{A histogram showing how many times ($y$) did an annotator place the next tag $x$ seconds after the previous one.} 
   \label{fig:hist}
\end{figure}
...
\begin{figure}[htbp]
   ...
   \caption{Detail of the histogram in \Fref{fig:hist} in an interval where we have placed our \emph{fluency} value for the preliminary experiment with clustering of work into annotation intervals (see \Sref{sec:time-analysis} and \Fref{fig:speed}).}
