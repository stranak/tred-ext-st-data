...
A total of 8,816 \semlex\ entries were used during annotations. As a result, all of these entries now have the tree structures as part of their entries, as described in \Sref{sec:semlex:entry}.
